...
Эта часть проекта представляет собою пользовательский интерфейс, в котором пользователю предоставляется выбор как и в участке кода с калибровкой (загрузка готового калибровочного файла или исполнение калибровочного кода после заполнения необходимых данных и загрузки калибровочного паттерна), так и в участке с загрузкой фотографий или 3 д модели.
